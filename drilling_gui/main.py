...
drill_button_on.grid(row=1, column=2)
drill_button_off.grid(row=1, column=1)
...
position_button_up = tkinter.Button(frame, text="Move Up", command=lambda: send_to_serial(arduino_serial, "up"))
position_button_down = tkinter.Button(frame, text="Move Down", command=lambda: send_to_serial(arduino_serial, "down"))
position_button_off = tkinter.Button(frame, text="Stop", command=lambda: send_to_serial(arduino_serial, "stop"))
position_button_up.grid(row=3, column=1)
# position_button_off.grid(row=3, column=2)
position_button_down.grid(row=3, column=3)
...
selection_button2.grid(row=5, column=1)
